...
const mockReq = { id: 1, moduleId: 1, reqId: 'SRS-0001', text: 'Req text', acceptanceCriteria: null, source: null, rationale: null, status: 'Draft' as const, priority: 'High' as const, reqType: 'Functional' as const, entryType: 'Requirement' as const, verificationStatus: 'Unverified' as const, verificationMethod: null, headingId: null, position: 0, deletedAt: null, createdAt: '', updatedAt: '', createdBy: null, updatedBy: null }
...
const mockConn: ArchitectureConnection = {
  ...
  name: null, connectionTypeId: null, lineStyle: null, markerStart: null, markerEnd: null, description: null,
  deletedAt: null, createdAt: '', updatedAt: ''
}
...
vi.stubGlobal('window', {
  api: {
    ...
    users: {
      me: vi.fn().mockResolvedValue({ uuid: 'u-1', displayName: 'Tester', email: null }),
      setMe: vi.fn().mockResolvedValue({ uuid: 'u-1', displayName: 'Renamed', email: null }),
