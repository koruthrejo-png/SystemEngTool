...
const mockReq = { id: 1, moduleId: 1, reqId: 'SRS-0001', text: 'Req text', acceptanceCriteria: null, source: null, rationale: null, status: 'Draft' as const, priority: 'High' as const, reqType: 'Functional' as const, entryType: 'Requirement' as const, verificationStatus: 'Unverified' as const, headingId: null, position: 0, deletedAt: null, createdAt: '', updatedAt: '', createdBy: null, updatedBy: null }
