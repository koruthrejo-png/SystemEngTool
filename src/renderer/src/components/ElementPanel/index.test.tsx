...
vi.mock('../../store', () => ({
  useStore: () => ({
    ...
    projectRequirements: [
      { id: 1, moduleId: 1, reqId: 'SRS-0001', text: 'The system shall thrust', acceptanceCriteria: null, source: null, rationale: null, status: 'Draft', priority: 'Medium', reqType: 'Functional', entryType: 'Requirement', headingId: null, position: 0, deletedAt: null, createdAt: '', updatedAt: '' }
    ],
