...
function req(partial: Partial<Requirement> & { id: number }): Requirement {
  return {
    ...
    status: 'Draft', priority: 'Medium', reqType: 'Functional', entryType: 'Requirement', verificationStatus: 'Unverified', verificationMethod: null,
    headingId: null, position: 0, deletedAt: null, createdAt: '', updatedAt: '2026-01-01',
    createdBy: null, updatedBy: null, ...partial
  }
}

const el = { id: 1, projectId: 1, architectureId: null, parentId: null, blockId: 'SYS-001', name: '', elementTypeId: null, description: null, color: null, lineStyle: null, fillColor: null, posX: 0, posY: 0, width: 160, height: 80, preNestWidth: null, preNestHeight: null, deletedAt: null, createdAt: '', updatedAt: '' }
